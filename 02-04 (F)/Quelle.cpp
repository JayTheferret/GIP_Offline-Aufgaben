...
int main()
{
	...
	cout << st1 << ":" << m1 << " und " << s1 << " Sekunden sind in Sekunden seit Mitternacht: " << ((st1 * 60) + m1) * 60 + s1 << endl;
	...
	cout << st2 << ":" << m2 << " und " << s2 << " Sekunden sind in Sekunden seit Mitternacht: " << ((st2 * 60) + m2) * 60 + s2 << endl;
